...
void f() {
  int x;
  auto [using x, y] = get();
  // expected-error@-1 {{'using' in a structured binding declaration is not enabled; pass -Xclang -fstructured-binding-assignment to enable this experimental extension}}
